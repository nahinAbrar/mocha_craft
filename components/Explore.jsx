...
const Explore = () => {
    return <section className="py-12 xl:py-0 xl:h-[90vh] xl:w-screen" id="explore">
        <div className="my-5 container mx-auto xl:w-full xl:h-full flex xl:justify-center xl:items-center">
            <div className="w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
                ...
                <div className="hidden lg:flex justify-center">
                    <div className="relative lg:w-[280px] lg:h-[450px] xl:w-[322px] xl:h-[500px]">
                        <Image
                ...
                <div className="flex-1 flex flex-col justify-around items-end text-center xl:text-left gap-12 xl:gap-0 max-w-[400px] mx-auto xl:max-w-none xl:mx-0">
                    {/*Item 3*/}
                    <div className="relative flex items-start">
                        <div className="xl:max-w-[420px] lg:text-left lg:flex lg:flex-col lg:items-start">
                            <div className="mb-6 flex justify-center xl:flex-col items-start">
